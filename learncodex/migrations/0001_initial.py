    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile', models.ImageField(storage=LearnIT.dropbox.DropboxStorage(), upload_to='learncodex/profile/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_img', models.ImageField(storage=LearnIT.dropbox.DropboxStorage(), upload_to='learnIT/images')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discription', models.TextField(max_length=10000)),
                ('video_720p', models.FileField(blank=True, null=True, storage=LearnIT.dropbox.DropboxStorage(), upload_to='course/learnIT/video_720p', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['mp4', 'webm'])])),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='learncodex.course')),
            ],
        ),
        migrations.CreateModel(
