    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dropbox_url', models.CharField(max_length=250, null=True)),
                ('discription', models.TextField(max_length=10000)),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='learncodex.course')),
                ('section', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='learncodex.coursesection')),
            ],
        ),
        migrations.CreateModel(
