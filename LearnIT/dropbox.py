...
class DropboxStorage(Storage):
    ...
    def __init__(self, location='/Public', ACCESS_TOKEN = settings.DROPBOX_ACCESS_TOKEN):
    ...
    def size(self, name):
        ...
        if not size:
            ...
            cache.set(cache_key, size, settings.DROPBOX_CACHE_TIMEOUT)
        return size
    ...
    def url(self, name):
        ...
        if not url:
            ...
            cache.set(cache_key, url, settings.DROPBOX_SHARE_LINK_CACHE_TIMEOUT)
